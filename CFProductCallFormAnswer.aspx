<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CFProductCallFormAnswer.aspx.cs" Inherits="CFProductCallFormAnswer" EnableViewStateMac="false" Title="Internet Call Form Input" EnableViewState="false"%>
...
function DisableButtons()
	{
        ...
        if (NEXTExists!=null)
        {
          ...
          var NEXTExists=document.getElementById("ctl00_ContentPlaceHolder1_Button5");
        if (NEXTExists!=null)
        {
         document.aspnetForm.ctl00$ContentPlaceHolder1$Button5.disabled=true;
        //"ctl00$ContentPlaceHolder1$Button6" value="Report"
        }
         var NEXTExists=document.getElementById("ctl00_ContentPlaceHolder1_Button6");
        if (NEXTExists!=null)
        {
...
function Back_Button()
	{	   
	   NewGridCallForm=document.aspnetForm.NewGridCallForm.value
	    DisableButtons()
	    if (NewGridCallForm=="Y")
	    {
...
<center>
 ...
 <asp:Label ID="photoMessage1"  Font-Bold="true"  Visible="false" ForeColor="Red" runat="server" Text="Your Store visit is not complete until you upload your photos." SkinID="LabelBlackSkin" ></asp:Label>
...
<br />
 ...
 <asp:Label ID="photoMessage2"  Font-Bold="true"  Visible="false" ForeColor="Red" runat="server" Text="Please click Next to upload your Photos." SkinID="LabelBlackSkin" ></asp:Label>    
<br />
<br />
...
<input name="NewGridCallForm" type="hidden" value="<%=NewGridCallForm%>"/>
<input name="NewGridCF_SaveAnsBack" type="hidden" value="<%=NewGridCF_SaveAnsBack%>"/>
