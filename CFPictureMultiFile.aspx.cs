...
public partial class CFPictureMultiFile : System.Web.UI.Page
{
    ...
    protected string Collect_iVR_Time, night_visits, Mileage_flag, Travel_flag, RotateFileSave, Rotate, Str_Manager_Title, Str_txt_Manager_name, NewScreenPage, BusRule_CommentBoxFlag;
    ...
    protected string Collect_Header, Collect_Call_Form, SS_Callform, Prod_Specific, qdef_skippattern, Max_Mx_Per_Store, Max_Visit_Per_Store_Mx, StrMTYPE, StrLogInMtype, StrPTYPE, StrPromptcheck;
    ...
    protected string Str_txt_mileage, Str_txt_drive, Str_rad_q_Past_Midnight, Str_rad_q_HH_Used, Str_rad_q_Ret_store_visit, StrServerName, Str_Start_time, GoLiteDate, Visit_time, Drive_Time_HH, Drive_Time_MM, CloudSwitch;
    protected string Str_Radio_EShelf, Str_Ask_EShelf_Question, Str_Bus_Rule3_Question, Str_rad_q_BR3, Str_Bus_Rule4_Question, Str_rad_q_BR4, Str_Bus_Rule5_Question, Client_id, PhotoFolderType;
    protected string Str_rad_q_BR5, Str_Bus_Rule6_Question, Str_rad_q_BR6, Str_Bus_Rule7_Question, Str_rad_q_BR7, Str_Bus_Rule28_Question, Str_rad_q_BR28, Hid_JavaFiles, StrRotateFileCount, StrFilenames, Photo_Q_No, Photo_By_QuestionFlag;
    protected int Back_Slash, Dot, Dash, ShowType, Lang_id,loopCnt;
    public DateTime StrDate;
    private string Str_Request_Method;
    private static int counter = 0;
    protected string Str_Start_time1, Str_Sv_Panel_id;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // Page.IsCallback  
        ...
        //***************************** hidden variables
       // num_cnt = Request.Form["IsPostBack_cnt"];
        ...
        if (!IsPostBack)
        {
                ...
                Str_Start_time1 = dt10.Rows[0][0].ToString().Trim();
                //Response.Write("Str_Start_time=" + Str_Start_time);
                UploadStartTime.Value = Str_Start_time1;
               // Context.Items["UploadStartTime"] = Str_Start_time1;
        }
   ...
   // protected void Attachments1_StartTime(object sender, EventArgs e) 
    //{
        //***** photo start time
    //    DataTable dt10 = Get_Start_time();
   ...
   //     Context.Items["UploadStartTime"] = Str_Start_time;
    ...
    {
        int StrFileYear, StrFileMonth, StrFileDay, StrFileHour, StrFileMinute, StrFileSecond, test, StrFileMilSec, uploadcount;
