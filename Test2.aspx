Output=9999,201032,1,3294713,99999,1,5/6/11,5/6/11 11:11 AM,5/6/11 11:34 AM,23,,1,,,H,N,1,N,05/06/11 13:54:22,Assistant Manager,johnm,1,,jmasud,jmasud,172.16.8.122<BR>confirmation_no=1605469<BR>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNDA5MDgwOTgwD2QWAmYPZBYCAgMPZBYCAgUPZBYCAgUPDxYCHgRUZXh0BQcxNjA1NDY5ZGRk" />
</div>
...
<hr color="dodgerblue">
<SPAN id="ShowDetail">
    <table border='1' id='TABLE1' borderColor='dodgerblue' bgcolor='mintcream' align='center' width='100%'> <tr><td  align='left' class='applicationnametd'><span class='reportTableHeader'>Job Information</span></td></tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Job No.</td><td class='selectionCriteriaItem' width='85%' align=left>:9999  Aramark Inventory</td></tr></table>	</td></tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Wave No.</td><td class='selectionCriteriaItem' width='85%' align=left>:201032  (FST DT:8/9/10- FEnd DT:12/30/11)</td></tr></table>	</td></tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Task No.</td><td class='selectionCriteriaItem' width='85%' align=left>:1  General Merchandising - Aramark Inventory</td></tr></table>	</td></tr><tr><td  align='left' class='applicationnametd'> <span class='reportTableHeader'>Chain Information</span> </td></tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Chain No.</td><td class='selectionCriteriaItem' width='85%' align=left>:2821  INTERNET DEMO C</td></tr></table>	</td></tr></tr><tr><td  align='left' class='applicationnametd'> <span class='reportTableHeader'>Store Information</span> </td></tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Store No.</td><td class='selectionCriteriaItem' width='85%' align=left>:52</td></tr></table>	</td></tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Store Name</td><td class='selectionCriteriaItem' width='85%' align=left>:INTERNET DEMO S</td></tr></table>	</td></tr><tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Address</td><td class='selectionCriteriaItem' width='85%' align=left>:12396 MAIN STREET</td></tr></table>	</td></tr><tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>City</td><td class='selectionCriteriaItem' width='85%' align=left>:GRAND RAPIDS</td></tr></table>	</td></tr><tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>State</td><td class='selectionCriteriaItem' width='85%' align=left>:MI</td></tr></table>	</td></tr><tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Zip</td><td class='selectionCriteriaItem' width='85%' align=left>:49501    </td></tr></table>	</td></tr><tr><tr><td align=left  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align=left>Phone No.</td><td class='selectionCriteriaItem' width='85%' align=left>:</td></tr></table></td></tr><tr><tr><td  align='left' class='applicationnametd'> <span class='reportTableHeader'>Visit Date</span> </td></tr><tr><td align='left'  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align='left'>Visit Date</td><td class='selectionCriteriaItem' width='85%' align='left'>:5/6/11</td></tr></table></td></tr><tr><td align='left'  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align='left'>Time In</td><td class='selectionCriteriaItem' width='85%' align='left'>:11:11 AM</td></tr></table></td></tr><tr><td align='left'  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align='left'>Time out</td><td class='selectionCriteriaItem' width='85%' align='left'>:11:34 AM</td></tr></table></td></tr><tr><td align='left'  width='100%'><table border='0'  width='100%'><tr><td class='reportCriteriaHeader'  width='10%' align='left'>Total Minutes</td><td class='selectionCriteriaItem' width='85%' align='left'>:23</td></tr></table></td></tr></table>
</SPAN>
...
<input name="Wave_No" type="hidden" value="201032" />
<input name="Task_No" type="hidden" value="1" />
<input name="Task_Desc" type="hidden" value="General Merchandising - Aramark Inventory" />
<input name="Task_Addtl_Desc" type="hidden" value="Aramark Inventory" />


<input name="store_id" type="hidden" value="3294713" />

<input name="Chain_No" type="hidden" value="2821" />
<input name="Store_Chain_Desc" type="hidden" value="INTERNET DEMO C" />
<input name="Store_No" type="hidden" value="52" />
<input name="Store_Store_Name" type="hidden" value="INTERNET DEMO S" />
<input name="Store_Street_Addr" type="hidden" value="12396 MAIN STREET" />
<input name="Store_City" type="hidden" value="GRAND RAPIDS" />
<input name="Store_State" type="hidden" value="MI" />
<input name="Store_Zip" type="hidden" value="49501    " />
...
<input name="Field_Start_Dt" type="hidden" value="8/9/10" />
<input name="Field_end_Dt" type="hidden" value="12/30/11" />
<input name="Key_Comp_Dt" type="hidden" value="12/30/11" />
<input name="DOA_Dt" type="hidden" value="12/30/11" />		
...
<input name="night_visits" type="hidden" value="Y" />
...
<input name="Data_Col_Method" type="hidden" value="H" />
...
<input name="Str_timein_hrs" type="hidden" value="11" />
<input name="Str_timein_min" type="hidden" value="11" />
<input name="Str_cmb_timein" type="hidden" value="AM" />
<input name="Str_timeout_hrs" type="hidden" value="11" />
...
<input name="Str_rad_q_Past_Midnight" type="hidden" value="1" />
<input name="Str_rad_q_HH_Used" type="hidden" value="1" />
...
<input name="Str_txt_Manager_name" type="hidden" value="johnm" />
<input name="ILang_Id" type="hidden" value="1"/>
<input name="Star_time" type="hidden" value="05/06/11 13:54:22"/>
<center>
<br />
  <br />
<span id="ctl00_ContentPlaceHolder1_Label11" class="LabelBlack" style="color:Red;font-weight:bold;">Answers are successfully Uploaded!</span>
 ...
 <span id="ctl00_ContentPlaceHolder1_confirm_Number" class="LabelBlack" style="color:Black;font-weight:bold;">1605469</span>
 <br />
   <br />
