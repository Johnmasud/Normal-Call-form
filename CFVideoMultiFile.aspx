<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CFVideoMultiFile.aspx.cs" Inherits="CFVideoMultiFile"   EnableViewStateMac="false" Title="Untitled Page" %>
...
//}
 ...
 function DoSubmitBack()
	{
	     DisableButtonsBack()
	    MultiVisit_VideoBackbtn=document.aspnetForm.MultiVisit_VideoBackbtn.value  
	    DisplayVideoBtn=document.aspnetForm.DisplayVideoBtn.value 
		    GoToPage="";
		   if (MultiVisit_VideoBackbtn=="Y")
              {
            	            GoToPage = "CFJWT_Input_Photo_Option.aspx";
              }
           else
               {
        ...
        // StrNewCallFormPathLink=document.aspnetForm.StrNewCallFormPathLink.value
         //    if (NewScreenPage=="Y")
         //    {
         //       GoToPage=StrNewCallFormPathLink   
          //   }
		        
	        if (DisplayVideoBtn=="Y")
	         {   
	           GoToPage= "CFJWTValidateSV.aspx";
             }
   ...
   DisableButtons()
		...
		if ((document.aspnetForm.ctl00$ContentPlaceHolder1$txt_visitmonth.value=="") || (document.aspnetForm.ctl00$ContentPlaceHolder1$txt_visitday.value=="") || (document.aspnetForm.ctl00$ContentPlaceHolder1$txt_visityear.value==""))
		...
		else
		 {
            ...
            document.aspnetForm.Visit_Dates.value=CorrectDate
            document.aspnetForm.PhotoCounter.value=0;
      ...
      document.aspnetForm.RotateFileCount.value=Filecount	
        for(var i=0;i<list.length;i++)
        {
               ...
               // alert("name=" + name) 
                ...
                File_name =ArrFilename[0].valueOf()
                File_Type=ArrFilename[1].valueOf()
                 document.aspnetForm.File_extension.value=File_Type 
...
function CuteWebUI_AjaxUploader_OnError(msg)
{
         ...
         POS=msg.indexOf("(")
         POS2=msg.indexOf(")")
         FileSize=msg.substring(POS+1,POS2)
          //alert("FileSize=" + FileSize);
          if (FileSize!="")
          {
                alert("Your file size is " + FileSize + ". This exceeds the maximum limit allowed. Please select a different file to upload");
          }
          else
          {
                alert(msg);
                                                    ...
                                                    <tr>
                                                        <td>
                                                           <table id="table4" style="width:385px; font-size:12px; font-weight:bold; font-family:Arial; text-align:left; border-right:solid 1px DodgerBlue; border-left:solid 1px DodgerBlue; border-top:solid 1px DodgerBlue;">
                                                            ...
                                                            <asp:Panel ID="Panel1" ScrollBars="Vertical"  CssClass="AjaxUploaderPanel" Height="50px" runat="server">
 ...
 <asp:Table ID="Table3" runat="server"  Width="100%" HorizontalAlign="Center" BorderWidth="0" bordercolor="dodgerblue">
     <asp:TableRow>
        <asp:TableCell HorizontalAlign="Center">
                 <asp:Label ID="Label1" runat="server" Text="Video Date:"   CssClass="selectionCriteriaItem"></asp:Label> 
                  <%
...
<table>  
 ...
 <br />
<asp:Label ID="Label2" Font-Bold="true" ForeColor="Red" runat="server" Text="The maximum number of files you can upload at one time is 1."  SkinID="LabelBlackSkin"></asp:Label>
 <br />
...
<%
 ...
 {
 %>				 
     <asp:Label ID="Label8" Font-Bold="true" ForeColor="Red" runat="server" Text="The file size limit is 29 MB."  SkinID="LabelBlackSkin"></asp:Label>
 <%
 }
 else
 {     
 %>  
     <asp:Label ID="Label9" Font-Bold="true" ForeColor="Red" runat="server" Text="The file size limit is 29 MB."  SkinID="LabelBlackSkin"></asp:Label>
 <%
  }
 %>
...
<input name="StrGridDates" type="hidden" value="<%=StrGridDates%>" />
 ...
 <input name="Photo_Ans_type" type="hidden" value="" />
...
<input name="Radio_Option_video" type="hidden"  value="<%=StrPhotoOption%>"/>
<input name="AllowVideoExtension" type="hidden"  value="<%=AllowVideoExtension%>"/>
<input name="PRD_origial_file_ex" type="hidden" value="" />
<input name="File_extension" type="hidden"/>
<input name="Visit_Dates" type="hidden" value=""   />
<input name="PhotoCounter" type="hidden" value=""  />  
<input name="NewScreenPage" type="hidden" value="<%=NewScreenPage%>"/>
 ...
 <input name="MultiVisit_VideoBackbtn" type="hidden" value="<%=MultiVisit_VideoBackbtn%>"/>
